...
export default function PeekCarousel({
  ...
  // ✅ FIX: The "center" transform now includes translateY(-50%) for consistent vertical alignment.
  ...
  return (
    <div className="relative mx-auto w-full max-w-none py-16">
      <div className="relative h-[340px] w-full overflow-visible md:h-[420px]">
        {images.map((image, index) => {
          ...
          return (
            <button
              ...
              className={`absolute top-1/2 left-1/2 h-[78%] w-[70%] overflow-hidden rounded-[32px] shadow-2xl transition-all ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-brand/60 focus-visible:ring-offset-4 ${
